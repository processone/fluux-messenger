    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Group chats: joining a busy room no longer announces its recent history as new arrivals, and accepting a contact request no longer re-announces messages you have already seen',
