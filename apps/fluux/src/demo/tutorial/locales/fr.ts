...
const tutorialFR = {
  ...
  'rooms-hint': {
    content: 'Les salons sont des conversations de groupe pour votre équipe.',
  ...
  'keyboard-shortcuts-hint': {
    content: 'Fluux se navigue entièrement au clavier. Utilisez Cmd+K pour changer de panneau, ou ? pour voir tous les raccourcis.',
    actionHint: 'Appuyez sur ? pour voir les raccourcis clavier',
  },
  'theme-hint': {
    content: 'Personnalisez Fluux : thèmes, couleurs d\'accentuation, polices et 34 langues.',
  ...
  'xmpp-console-hint': {
    content: 'Pour les développeurs : la console XMPP affiche chaque stanza entrant et sortant.',
    actionHint: 'Ouvrez Paramètres > Console XMPP pour voir les paquets en direct',
  },
  'tour-complete': {
    content: 'C\'est la fin de la visite ! Tout est actif ici, explorez librement. Profitez de Fluux ! ✨',
  },
  skip: 'Passer',
} as const
