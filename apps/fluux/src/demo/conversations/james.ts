...
export const JAMES_MESSAGES: Message[] = [
  ...
  {
    type: 'chat', id: 'demo-james-0a', stanzaId: undefined, originId: undefined, from: conv, body: 'I set up the end-to-end test suite for the chat module',
    timestamp: daysAgo(2), isOutgoing: false, conversationId: conv,
  },
  {
    type: 'chat', id: 'demo-james-0b', stanzaId: undefined, originId: undefined, from: SELF_JID, body: 'What framework did you go with? Playwright or Cypress?',
    timestamp: daysAgo(2), isOutgoing: true, conversationId: conv,
  },
  {
    type: 'chat', id: 'demo-james-0c', stanzaId: undefined, originId: undefined, from: conv, body: 'Playwright — better for testing WebSocket connections and it runs headless in CI',
    timestamp: daysAgo(2), isOutgoing: false, conversationId: conv,
  },
  {
    type: 'chat', id: 'demo-james-0d', stanzaId: undefined, originId: undefined, from: SELF_JID, body: 'Good call. Can you add a test for the reconnection flow? That\'s been flaky',
    timestamp: daysAgo(2), isOutgoing: true, conversationId: conv,
  },
  {
    type: 'chat', id: 'demo-james-0e', stanzaId: undefined, originId: undefined, from: conv, body: 'On it. I\'ll simulate a network drop and verify the message queue is flushed after reconnect',
    timestamp: daysAgo(2), isOutgoing: false, conversationId: conv,
    reactions: { '🙌': [SELF_JID] } as Record<string, string[]>,
  },
  // Today's conversation
  {
    type: 'chat', id: 'demo-james-1', stanzaId: undefined, originId: undefined, from: conv, body: 'Have you seen the blog post about the latest release?',
    timestamp: hoursAgo(6), isOutgoing: false, conversationId: conv,
  },
  {
    type: 'chat', id: 'demo-james-2', stanzaId: undefined, originId: undefined, from: conv,
  ...
  {
    type: 'chat', id: 'demo-james-3', stanzaId: undefined, originId: undefined, from: SELF_JID, body: 'Nice! The part about stream management is very relevant to what we\'re building next',
    timestamp: hoursAgo(5), isOutgoing: true, conversationId: conv,
  },
  {
    type: 'chat', id: 'demo-james-4', stanzaId: undefined, originId: undefined, from: conv, body: 'Exactly what I thought. We should leverage more of XEP-0198',
  ...
  {
    type: 'chat', id: 'demo-james-5', stanzaId: undefined, originId: undefined, from: SELF_JID, body: 'Already on it — session resumption is working nicely in the latest build 🚀',
    timestamp: hoursAgo(4), isOutgoing: true, conversationId: conv,
    reactions: { '💪': [conv] },
  },
  {
    type: 'chat', id: 'demo-james-6', stanzaId: undefined, originId: undefined, from: conv,
  ...
  {
    type: 'chat', id: 'demo-james-7', stanzaId: undefined, originId: undefined, from: SELF_JID,
  ...
  {
    type: 'chat', id: 'demo-james-7b', stanzaId: undefined, originId: undefined, from: conv,
  ...
  {
    type: 'chat', id: 'demo-james-7c', stanzaId: undefined, originId: undefined, from: SELF_JID,
  ...
  {
    type: 'chat', id: 'demo-james-7d', stanzaId: undefined, originId: undefined, from: conv,
  ...
  {
    type: 'chat', id: 'demo-james-7e', stanzaId: undefined, originId: undefined, from: SELF_JID,
  ...
  {
    type: 'chat', id: 'demo-james-8', stanzaId: undefined, originId: undefined, from: conv, body: 'By the way, I found a bug in the error handling — when the server returns a 503, we retry immediately instead of backing off',
    timestamp: hoursAgo(2), isOutgoing: false, conversationId: conv,
  },
  {
    type: 'chat', id: 'demo-james-9', stanzaId: undefined, originId: undefined, from: SELF_JID, body: 'Good catch. Let\'s add exponential backoff with jitter to avoid thundering herd',
