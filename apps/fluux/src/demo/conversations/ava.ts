...
export const AVA_MESSAGES: Message[] = [
  ...
  {
    type: 'chat', id: 'demo-ava-1', stanzaId: undefined, originId: undefined, from: conv, body: 'I\'ve been reviewing the Q1 user feedback — a few themes keep coming up',
    timestamp: daysAgo(1), isOutgoing: false, conversationId: conv,
  },
  {
    type: 'chat', id: 'demo-ava-2', stanzaId: undefined, originId: undefined, from: SELF_JID, body: 'What are the top asks?',
    timestamp: daysAgo(1), isOutgoing: true, conversationId: conv,
  },
  {
    type: 'chat', id: 'demo-ava-3', stanzaId: undefined, originId: undefined, from: conv, body: 'Message search is #1 by far. Users want to find old conversations quickly. Reactions and threads are close behind.',
    timestamp: daysAgo(1), isOutgoing: false, conversationId: conv,
    reactions: { '📊': [SELF_JID] } as Record<string, string[]>,
  },
  {
    type: 'chat', id: 'demo-ava-4', stanzaId: undefined, originId: undefined, from: SELF_JID, body: 'Good news — search shipped last week with full archive support. I\'ll demo it at the next all-hands',
    timestamp: daysAgo(1), isOutgoing: true, conversationId: conv,
  },
  {
    type: 'chat', id: 'demo-ava-5', stanzaId: undefined, originId: undefined, from: conv, body: 'That\'s great timing! I\'ll update the roadmap and send the changelog to beta testers',
    timestamp: daysAgo(1), isOutgoing: false, conversationId: conv,
  },
  // Today — roadmap discussion
  {
    type: 'chat', id: 'demo-ava-6', stanzaId: undefined, originId: undefined, from: conv, body: 'For Q2, I\'m thinking we prioritize: voice/video calls, end-to-end encryption, and mobile apps',
    timestamp: hoursAgo(6), isOutgoing: false, conversationId: conv,
  },
  {
    type: 'chat', id: 'demo-ava-7', stanzaId: undefined, originId: undefined, from: SELF_JID, body: 'Voice/video is the biggest lift. We\'d need to integrate Jingle (XEP-0166) for that',
    timestamp: hoursAgo(5.5), isOutgoing: true, conversationId: conv,
  },
  {
    type: 'chat', id: 'demo-ava-8', stanzaId: undefined, originId: undefined, from: conv, body: 'What about OMEMO for E2EE? The privacy-focused users have been very vocal about it',
  ...
  {
    type: 'chat', id: 'demo-ava-9', stanzaId: undefined, originId: undefined, from: SELF_JID, body: 'OMEMO (XEP-0384) is on the list — it\'s well-specified and we have a good crypto library ready. Should be feasible in Q2.',
  ...
  {
    type: 'chat', id: 'demo-ava-10', stanzaId: undefined, originId: undefined, from: conv, body: 'Heads up — a new device is on my account. I haven\'t verified its fingerprint yet.',
  ...
  {
    type: 'chat', id: 'demo-ava-11', stanzaId: undefined, originId: undefined, from: conv, body: 'Following up on search — I\'ll put together a proper rollout plan this week.',
    timestamp: minutesAgo(4), isOutgoing: false, conversationId: conv,
    securityContext: { protocolId: 'openpgp', trust: 'tofu' },
  },
  {
    type: 'chat', id: 'demo-ava-12', stanzaId: undefined, originId: undefined, from: conv, body: '…and just noting that this reply is from my laptop — haven\'t verified its key from phone yet.',
    timestamp: minutesAgo(3), isOutgoing: false, conversationId: conv,
    securityContext: { protocolId: 'openpgp', trust: 'untrusted' },
  },
  {
    type: 'chat', id: 'demo-ava-13', stanzaId: undefined, originId: undefined, from: conv, body: 'Back on the main device now.',
  ...
  {
    type: 'chat', id: 'demo-ava-14', stanzaId: undefined, originId: undefined, from: conv, body: 'Weird — this message shows up but my laptop says it couldn\'t verify the signature. Hmm.',
  ...
  // together by the UI).
  {
    type: 'chat', id: 'demo-ava-14b', stanzaId: undefined, originId: undefined, from: SELF_JID, body: 'Let me take a look.',
  ...
  // silently dropped.
  {
    type: 'chat', id: 'demo-ava-15', stanzaId: undefined, originId: undefined, from: conv, body: '[OpenPGP-encrypted message]',
    timestamp: minutesAgo(1), isOutgoing: false, conversationId: conv,
    securityContext: {
      protocolId: 'openpgp',
      trust: 'untrusted',
  ...
  {
    type: 'chat', id: 'demo-ava-16', stanzaId: undefined, originId: undefined, from: conv,
