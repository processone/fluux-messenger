...
export const tokyoNightTheme: ThemeDefinition = {
  ...
  variables: {
    dark: {
      ...
      '--syntax-token-comment': '#565f89',
      '--syntax-token-function': '#7aa2f7',
      '--syntax-token-constant': '#ff9e64',
      '--syntax-token-parameter': '#c0caf5',
      '--syntax-token-punctuation': '#89ddff',
      '--syntax-token-link': '#7aa2f7',
    },
    light: {
      ...
      '--syntax-token-comment': '#848cb5',
      '--syntax-token-function': '#2e7de9',
      '--syntax-token-constant': '#965027',
      '--syntax-token-parameter': '#3760bf',
      '--syntax-token-punctuation': '#2e7de9',
      '--syntax-token-link': '#2e7de9',
    },
  },
  swatches: {
