...
export const catppuccinMochaTheme: ThemeDefinition = {
  ...
  variables: {
    dark: {
      ...
      '--syntax-token-comment': '#6c7086',
      '--syntax-token-function': '#89b4fa',
      '--syntax-token-constant': '#fab387',
      '--syntax-token-parameter': '#f2cdcd',
      '--syntax-token-punctuation': '#9399b2',
      '--syntax-token-link': '#89b4fa',
    },
    light: {
      ...
      '--syntax-token-comment': '#8c8fa1',
      '--syntax-token-function': '#1e66f5',
      '--syntax-token-constant': '#fe640b',
      '--syntax-token-parameter': '#dd7878',
      '--syntax-token-punctuation': '#6c6f85',
      '--syntax-token-link': '#1e66f5',
    },
  },
  swatches: {
