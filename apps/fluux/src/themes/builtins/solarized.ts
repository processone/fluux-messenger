...
export const solarizedTheme: ThemeDefinition = {
  ...
  variables: {
    dark: {
      ...
      '--syntax-token-string-expression': '#2aa198',
      '--syntax-token-comment': '#586e75',
      '--syntax-token-function': '#268bd2',
      '--syntax-token-constant': '#cb4b16',
      '--syntax-token-parameter': '#93a1a1',
      '--syntax-token-punctuation': '#839496',
      '--syntax-token-link': '#268bd2',
    },
    light: {
      ...
      '--syntax-token-string': '#2aa198',
      '--syntax-token-string-expression': '#2aa198',
      '--syntax-token-comment': '#93a1a1',
      '--syntax-token-function': '#268bd2',
      '--syntax-token-constant': '#cb4b16',
      '--syntax-token-parameter': '#657b83',
      '--syntax-token-punctuation': '#586e75',
      '--syntax-token-link': '#268bd2',
    },
  },
  swatches: {
