...
export const monokaiTheme: ThemeDefinition = {
  ...
  variables: {
    dark: {
      ...
      // Syntax highlighting
      '--syntax-token-keyword': '#f92672',
      '--syntax-token-string': '#e6db74',
      '--syntax-token-string-expression': '#e6db74',
      '--syntax-token-comment': '#75715e',
      '--syntax-token-function': '#a6e22e',
      '--syntax-token-constant': '#ae81ff',
      '--syntax-token-parameter': '#fd971f',
      '--syntax-token-punctuation': '#f8f8f2',
      '--syntax-token-link': '#fd971f',
    },
    ...
    light: {
      ...
      '--syntax-token-string': '#9e8e10',
      '--syntax-token-string-expression': '#9e8e10',
      '--syntax-token-comment': '#a8a497',
      '--syntax-token-function': '#5f8c0c',
      '--syntax-token-constant': '#7540c9',
      '--syntax-token-parameter': '#b86e0a',
      '--syntax-token-punctuation': '#272822',
      '--syntax-token-link': '#b86e0a',
    },
  },
  swatches: {
