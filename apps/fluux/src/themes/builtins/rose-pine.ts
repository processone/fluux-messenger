...
export const rosePineTheme: ThemeDefinition = {
  ...
  variables: {
    ...
    light: {
      ...
      '--syntax-token-string': '#ea9d34',
      '--syntax-token-string-expression': '#ea9d34',
      '--syntax-token-comment': '#9893a5',
      '--syntax-token-function': '#b4637a',
      '--syntax-token-constant': '#907aa9',
      '--syntax-token-parameter': '#56949f',
      '--syntax-token-punctuation': '#797593',
      '--syntax-token-link': '#d7827e',
    },
  },
  swatches: {
