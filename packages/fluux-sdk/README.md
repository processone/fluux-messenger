...
- **Messaging**: XEP-0085 (Typing indicators), XEP-0308 (Message Correction), XEP-0313 (MAM), XEP-0363 (HTTP Upload), XEP-0393 (Styling), XEP-0424 (Retraction), XEP-0425 (Moderation), XEP-0444 (Reactions), XEP-0461 (Replies), XEP-0490 (Read-position sync)
